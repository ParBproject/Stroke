---
title: "Earlier R pass — maintained analysis is the Python casebook"
author: "ParBproject"
date: "`r Sys.Date()`"
output:
...
> Maintained analysis: the Python casebook (`python3 -m casebook.analyze`, page at `casebook/index.html`). This R Markdown file is an earlier unmaintained pass.

# About Data Analysis Report

The maintained casebook is the Python page at the repository root (`index.html`, `casebook/analyze.py`). This R Markdown is an earlier pass and is not re-knit in CI.
